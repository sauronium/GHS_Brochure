...
export default function Home() {
  ...
  const impactStats: ImpactStat[] = [
    { value: "75+", label: "Countries", iconSrc: "/icons/75+Countries.svg", iconAlt: "Countries Icon" },
    { value: "120+", label: "Health Campaigns", iconSrc: "/icons/health_campaigns.svg", iconAlt: "Health Icon" },
    { value: "500M+", label: "Lives Touched", iconSrc: "/icons/lives_touched.svg", iconAlt: "Lives Icon" },
    { value: "1000+", label: "Strategic Partners", iconSrc: "/icons/strategic_partners.svg", iconAlt: "partners Icon" },
    { value: "50+", label: "Global Health Experts", iconSrc: "/icons/global_health_experts.svg", iconAlt: "experts Icon" },
    { value: "20", label: "Years of Impact", iconSrc: "/icons/20_years_of_impact.svg", iconAlt: "impact Icon" },
  ];
  ...
  return (
    <>
      <div className="relative bg-[#FBFBFB]">
        <div className="w-full mx-auto mb-16 md:mb-32">
          {/* Desktop Layout */}
          ...
          <div className="lg:hidden pt-20 px-4">
            {/* Red Box First */}
            <div className="bg-[#AC3F06] text-white p-8 mb-6 shadow-lg">
            ...
            <div className="mb-6 text-center px-4">
              <h2 className="text-xl sm:text-2xl font-light text-gray-800 leading-relaxed">
                Impacting Lives and
                <br />
                Providing Solutions
                <br />
            ...
            <div className="relative w-full h-[300px] sm:h-[400px]">
              <div className="relative w-full h-full overflow-hidden rounded-lg">
                ...
                <button
                  onClick={handlePreviousImage}
                  className="absolute left-2 top-1/2 transform -translate-y-1/2 z-10 w-10 h-10 bg-black/50 hover:bg-black/70 text-white rounded-full flex items-center justify-center transition-colors duration-300"
                >
                  <ChevronLeftIcon />
                </button>
                ...
                <button
                  onClick={handleNextImage}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 z-10 w-10 h-10 bg-black/50 hover:bg-black/70 text-white rounded-full flex items-center justify-center transition-colors duration-300"
                >
                  <ChevronRightIcon />
                </button>
        ...
        {/* Stats Section */}
        <div className="bg-[#FFD22D] py-12 md:py-16 mb-16 md:mb-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 text-center">
              {impactStats.map((stat: ImpactStat) => (
                <div key={stat.label} className="flex flex-col items-center">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 border-2 border-black rounded-full flex items-center justify-center mb-2 md:mb-4">
                    <Image
                      src={stat.iconSrc}
                      alt={stat.iconAlt}
                      width={50}
                      height={50}
                      className="text-black sm:w-[60px] sm:h-[60px] md:w-[70px] md:h-[70px]"
                    />
                  </div>
                  <p className="text-2xl sm:text-3xl md:text-4xl font-medium text-gray-900">
                    {stat.value}
                  </p>
                  <p className="text-sm sm:text-lg md:text-xl text-gray-800 mt-1">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* About GHS Section */}
        <div className="relative bg-[#3B818F] py-16 md:py-28">
          <div className="max-w-7xl mx-auto px-4 relative">
            {/* Earth Image - Smaller on Mobile */}
            <div className="absolute -top-28 md:-top-45 right-3 md:right-0 z-10">
            ...
            <div className="text-center text-white">
              <h2 className="text-3xl md:text-5xl font-bold mb-10 md:mb-16 tracking-wide">
                ABOUT GHS
              </h2>

              <h3 className="text-2xl md:text-4xl font-light mb-8 md:mb-12 tracking-wide px-4">
                GLOBAL HEALTH STRATEGIES AT A GLANCE
              </h3>

              <div className="max-w-5xl mx-auto space-y-4 md:space-y-5 px-4">
                ...
                <p className="text-base md:text-xl leading-relaxed mb-8 md:mb-14">
                  With every initiative, we aim to amplify critical issues,
                  mobilize resources, and support movements that create lasting
                  impact in global health and development.
                </p>
              ...
              <button className="flex items-center mx-auto bg-transparent border-2 border-white text-white px-4 md:px-6 py-2 md:py-3 rounded-full hover:bg-white hover:text-[#4A90A4] transition-colors duration-300 font-medium tracking-wide text-sm md:text-base">
                DISCOVER FULL STORY{" "}
                <span className="w-6 h-6 ml-2 rounded-full flex items-center justify-center bg-transparent border-2 hover:bg-white hover:border-[#4A90A4] hover:text-[#4A90A4] transition-colors duration-300">
                  <ChevronRightIcon sx={{ verticalAlign: "top", fontSize: 20 }} />
                </span>
              </button>
            </div>
          </div>
          ...
          <div className="mt-16 md:mt-20 text-center px-4">
            ...
            <div className="flex justify-center mt-8 md:mt-14 mb-10 md:mb-16">
              <div className="flex bg-white/20 overflow-hidden  w-full max-w-md md:max-w-none">
                {regions.map((region: Region) => (
                  <button
                    key={region}
                    onClick={() => handleRegionChange(region)}
                    className={`flex-1 px-4 sm:px-8 md:px-28 py-2 text-base sm:text-lg md:text-[22px] font-bold border-r-1 border-gray-300 last:border-r-0 transition-colors duration-300 ${
                      activeRegion === region
                        ? "bg-[#D2691E] text-white"
                        : "text-white hover:bg-white/20"
                    }`}
            ...
            {/* Leadership Display - Desktop (3 people) */}
            <div className="hidden md:flex items-center justify-center space-x-48 mb-14">
              {/* Previous Leader (Left) */}
              <div className="text-center opacity-50 transform scale-75 transition-all duration-300">
                <div className="bg-white/70 text-[#4A90A4] px-7 py-0.5 mb-3 inline-block">
                  <h4 className="text-lg font-medium">
                    {currentLeaders[(currentLeaderIndex - 1 + currentLeaders.length) % currentLeaders.length].name}
                  </h4>
                </div>
                <p className="text-white text-sm">
                  {currentLeaders[(currentLeaderIndex - 1 + currentLeaders.length) % currentLeaders.length].designation}
                </p>
              </div>
              ...
              <div className="text-center opacity-50 transform scale-75 transition-all duration-300">
                <div className="bg-white/70 text-[#4A90A4] px-7 py-0.5 mb-3 inline-block">
                  <h4 className="text-lg font-medium">
                    {currentLeaders[(currentLeaderIndex + 1) % currentLeaders.length].name}
                  </h4>
                </div>
                <p className="text-white text-sm">
                  {currentLeaders[(currentLeaderIndex + 1) % currentLeaders.length].designation}
                </p>
              </div>
            </div>

            {/* Leadership Display - Mobile (1 person only) */}
            <div className="md:hidden mb-10">
              <div className="text-center opacity-100 transition-all duration-300">
                <div className="bg-white text-[#4A90A4] px-6 py-2 mb-3 inline-block rounded">
            ...
            <div className="flex items-center justify-center space-x-5 mb-6">
              <button
                onClick={handlePrevious}
                className="w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-white flex items-center justify-center hover:bg-white hover:text-[#4A90A4] transition-colors duration-300"
              >
                <ChevronLeftIcon />
              </button>
            ...
            {/* Our Work Section */}
            <div className="text-center text-white mt-16 md:mt-24">
              <h2 className="text-2xl md:text-4xl font-light text-white tracking-wide mb-6 md:mb-8">
                OUR WORK
              </h2>
        ...
        <div className="py-16 md:py-28">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-bold text-[#3B818F] mb-8 md:mb-12 tracking-wide">
                SERVICES
              </h2>
